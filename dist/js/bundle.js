...
var _basket = __webpack_require__(28);

var _basket2 = _interopRequireDefault(_basket);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

_reactDom2.default.render(_react2.default.createElement(_basket2.default, null), document.querySelector('main'));
...
var _productsGrid = __webpack_require__(29);
  ...
  _createClass(Blog, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        'div',
        { className: 'basket' },
        _react2.default.createElement(_productsGrid2.default, { basket: _data2.default.basket }),
        _react2.default.createElement(_progress2.default, { dataProgress: _data2.default.basketProgress })
      );
    }
  }]);
...
var _productRow = __webpack_require__(30);
...
var ProductsGrid = function (_React$Component) {
  ...
  function ProductsGrid() {
    ...
    return _possibleConstructorReturn(this, (ProductsGrid.__proto__ || Object.getPrototypeOf(ProductsGrid)).apply(this, arguments));
  }
  ...
  _createClass(ProductsGrid, [{
    ...
    value: function render() {
      ...
      if (basket) {
        rows = basket.map(function (product, i) {
          return _react2.default.createElement(_productRow2.default, { product: product, key: i });
        });
      }
...
var ProductRow = function (_React$Component) {
  ...
  _createClass(ProductRow, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        'div',
        { className: 'basket-grid__row' },
        _react2.default.createElement('img', { src: this.props.product.preview, alt: 'pizza', title: 'pizza', className: 'basket-grid__product-img' }),
        _react2.default.createElement(
          'div',
          { className: 'basket-grid__product-name' },
          this.props.product.name
        ),
        _react2.default.createElement(
          'div',
          { className: 'basket-grid__product-description' },
          this.props.product.description
        ),
        _react2.default.createElement(
          'div',
          { className: 'basket-grid__product-buttons-wrapper' },
          _react2.default.createElement(
            'div',
            { className: 'basket-grid__product-counter-wrapper' },
            _react2.default.createElement(
              'div',
              { className: 'basket-grid__product-decr' },
              '\u2013'
            ),
            _react2.default.createElement(
              'div',
              { className: 'basket-grid__product-count' },
              this.props.product.counter
            ),
            _react2.default.createElement(
              'div',
              { className: 'basket-grid__product-incr' },
              '+'
            )
          ),
          _react2.default.createElement('input', { type: 'button', value: '\u0423\u0434\u0430\u043B\u0438\u0442\u044C', className: 'basket-grid__product-toggle-btn' })
        )
      );
    }
  }]);
...
window.addEventListener('load', function () {
  ...
  // counter logic
  var decrArr = document.querySelectorAll('.basket-grid__product-decr');
  var incrArr = document.querySelectorAll('.basket-grid__product-incr');
  var counterValArr = document.querySelectorAll('.basket-grid__product-count');

  counterValArr.forEach(function (countarVal, i) {
    if (counterValArr[i].innerHTML === '1') {
      decrArr[i].classList.add('basket-grid__product-decr_inactive');
    }
  });

  incrArr.forEach(function (incr, i) {
    incr.addEventListener('click', function () {
      counterValArr[i].innerHTML = ++counterValArr[i].innerHTML;
      if (+counterValArr[i].innerHTML > 1) decrArr[i].classList.remove('basket-grid__product-decr_inactive');
    });
  });

  decrArr.forEach(function (decr, i) {
    decr.addEventListener('click', function () {
      if (+counterValArr[i].innerHTML > 1) {
        counterValArr[i].innerHTML = --counterValArr[i].innerHTML;
        if (+counterValArr[i].innerHTML === 1) decrArr[i].classList.add('basket-grid__product-decr_inactive');
      }
    });
  });

  // del-btn (toggle) logic
  var toggleBtnArr = document.querySelectorAll('.basket-grid__product-toggle-btn');
  var rowArr = document.querySelectorAll('.basket-grid__row');

  toggleBtnArr.forEach(function (btn, i) {
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'div',
          null,
          _react2.default.createElement('progress', { max: '100', 'data-progress': this.props.dataProgress }),
          _react2.default.createElement('div', { className: 'progress__val' })
        )
      );
    }
  }]);
...
window.addEventListener('load', function () {
  ...
  var progressVal = document.querySelector('.progress__val');
  ...
  var shiftVal = 15 + progressWidth; // значения сдвига до нуля
